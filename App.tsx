...
import { Download, User, Building2, Phone, Mail, Globe, Upload, Trash2 } from 'lucide-react';
      ...
      <div className="max-w-6xl mx-auto">
        <header className="mb-10 text-center md:text-left">
          ...
          <p className="text-slate-500 text-lg">
            Personalize seus dados e exporte sua assinatura como imagem PNG (300x180px).
          </p>
        </header>
